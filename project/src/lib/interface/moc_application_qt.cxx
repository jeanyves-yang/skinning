...
static const char qt_meta_stringdata_application_qt[] = {
    "application_qt\0"
};
...
const QMetaObjectExtraData application_qt::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject application_qt::staticMetaObject = {
    { &QApplication::staticMetaObject, qt_meta_stringdata_application_qt,
      qt_meta_data_application_qt, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &application_qt::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_application_qt))
        return static_cast<void*>(const_cast< application_qt*>(this));
